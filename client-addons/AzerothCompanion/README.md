...
status, behaviour, bag-logistics status, side-by-side progress for quests shared
with the logged-in leader, and separate progress for class or profession quests
held only by the companion. Each companion also has quick Questing, Dungeon Tank, Dungeon Healer,
...
The module and addon currently use companion protocol version 5. The panel reports a
